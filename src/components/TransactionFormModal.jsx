...
const TransactionFormModal = ({
  ...
  const handleSubmit = async (values) => {
    ...
    if (!client || !project || !txDate || amountRaw === '' || amountRaw == null || !Number.isFinite(amountNum) || amountNum <= 0) {
      setSubmitError('Broker, project, date, and a valid amount are required.');
      return;
    }
