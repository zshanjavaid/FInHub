  ...
  <div className="w-full min-w-0 bg-white rounded-2xl shadow-card overflow-hidden border border-slate-200/80 border-t-[3px] border-t-primary-600">
    {title && (
      <div className="px-4 pt-5 pb-1 sm:px-6 sm:pt-6 sm:pb-2">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-[0.95]">{title}</h1>
        {subtitle ? <p className="text-sm font-light text-slate-500 mt-2.5 max-w-prose leading-relaxed">{subtitle}</p> : null}
